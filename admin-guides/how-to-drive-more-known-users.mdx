...
**Set up the advanced instrumentation.** When a user signs up or logs in to your app, they are identifying themselves, so you'll be able to know exactly who is doing what in your app. We also find that some of the best intent is happening in your app — maybe you have a user paying you a little bit, but they are showing intent that they need something more sophisticated. 
