...
**Set up contact identity tracking.** When a user signs up or logs in to your app, they are identifying themselves, so you'll be able to know exactly who is doing what in your app. In addition to getting more known users, you'll also be able to see what those users are doing in your application, which can be quite helpful for <a href="/docs/admin-guides/advanced-intent-signals">finding the hottest intent</a>!

<Note>
	This guide has more information on setting up 
	<a href="/docs/developer-guides/sending-identify">Contact Identity Setup</a>.
</Note>
