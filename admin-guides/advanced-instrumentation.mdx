...
![](/images/advanced-instrumentation/koala-web.png)

...into a workspace that looks like this:

![](/images/advanced-instrumentation/koala-accounts.png)

...with account level traits that look like this (right):

![](/images/advanced-instrumentation/koala-single-account.png)
