...
This guide is meant to be inspiration for some of our favorite advanced intent signals. 

Note that both the basic instrumentation and advanced instrumentation are required before you can do these. But we do believe that these advanced intent signals can be nirvana for sales reps.
