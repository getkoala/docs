...
We hope you find that the default base packages are pretty reasonable and a good starting point. Working from the base package, you may need too add extra Licenses (one per rep) and/or Account packs (these are companies we've seen in your webiste and stored in Koala's platform). If you have a high-traffic website or high-volume product analytics implementation, you may also need to consider Event packs, but this is less frequently needed.

## Plan summary

Below is an overview of the pricing grid. All prices are **per month**, but we offer annual pricing (~10% discount) for annual pre-paid commitments. Please email support@getkoala.com if you're interested.
