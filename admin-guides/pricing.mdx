...
| Plan | Koala App | Intent Signals | Slack Alerts | Koala Weekly | CRM Automations |
| --- | --- | --- | --- | --- | --- | 
| Free | ✅ | ✅ | ✅ | ✅ | ❌ |
| Team | ✅ |  ✅ | ✅ | ✅ | ❌ |
| Business | ✅ |  ✅ | ✅ | ✅ | ✅ |
...
<Note>
While Koala collects all data automatically, you can exclude any account that is not valuable to you with <a href="app.getkoala.com/goto/settings/excluded-accounts">excluded account filters</a>. 
</Note>
...
- *How many accounts are in Koala? (Find the gray number on your <a href="app.getkoala.com/goto/accounts">accounts page</a>.)*
- *Can I cut some of the less interesting ones using <a href="app.getkoala.com/goto/settings/excluded-accounts">excluded account filters</a>?*
