...
<Note>
While Koala collects all data automatically, you can exclude any account that is not valuable to you with <a href="/goto/settings/excluded-accounts">excluded account filters</a>. 
</Note>
...
- *Can I cut some of the less interesting ones using <a href="/goto/settings/excluded-accounts">excluded account filters</a>?*
