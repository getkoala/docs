...
Conversion windows can be set to 7 days, 14 days, 28 days, or 90 days. Typically, if you're trying to determine "sales-ready" signals, we recommend using a shorter conversion window of 7-28 days depending on how long it takes between content consumption and your conversion event to happen in a typical sales cycle. However, if you're trying to understand the performance of more top of funnel / awarness content (eg., a blog post), it may make sense to consider a longer conversion window of 90 days, since you wouldn't expect for that top of funnel content to immediately convert to a sales opportunity.
