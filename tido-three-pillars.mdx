...
The most common conversation I have with people is when they are considering a career move, whether it's their <a href="https://randsinrepose.com/archives/shields-down/">"Shields Down" moment</a> or deep in the offer process. Over the years, I've seen some absurdly complex spreadsheets (eg., 15 pros and cons, expected value of equity, concerns about RSUs/Options/Strike Price, etc.). And while I do think there is a place for those spreadsheets, I've craved a simpler model. 
