...
Koala integrates with Salesforce CRM for Campaign. If you need that data in Salesforce Data Cloud, it is necessary to integrate the Salesforce Sales Cloud (CRM) with Salesforce Data Cloud directly.
