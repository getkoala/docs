...
<Note>
  ...
  You may have to manually enter the URL to find it (replace `YOUR_WORKSPACE_SLUG` with your workspace's slug!): `https://app.segment.com/YOUR_WORKSPACE_SLUG/destinations/catalog/actions-koala-cloud`
</Note>
