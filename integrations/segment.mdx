...
Navigate to your Segment workspace. Visit the [Koala Cloud Destination](https://app.segment.com/goto-my-workspace/destinations/catalog/actions-koala-cloud) in the Segment catalog and click "Configure Koala Cloud".
...
<Note>
  ...
  You can link directly to it via the following URL: https://app.segment.com/goto-my-workspace/destinations/catalog/actions-koala-cloud
</Note>
