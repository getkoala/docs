...
- **Action Credits**: Credits are deducted when any succesfull Automation is run. i.e. when Intent Data is delivered to your destination.

- **Auto Outbound Credits**: Credits are deducted when any Auto Outbound prospect is sent to your destination. 
