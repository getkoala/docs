...
2. Set up a Play that is triggered every day (or whenever)
3. Specify the list we added companies to as a source – under "At Least One Account List" filter in the IF section
