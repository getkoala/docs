...
<Note>
    In order to use Slack Alerts, you'll first need to connect your Slack workspace to Koala. Read more about the <a href="/integrations/slack">Slack integration</a>.
</Note>
