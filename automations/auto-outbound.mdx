...
- [Intent Signals](/docs/admin-guides/first-intent-signals) allow you to map your website and product usage to signals you Sales Team understands.
- [Content Reports](/docs/product-manual/content-reports) help you track the conversion rate of each Intent Signal, and understand which Signals and Content drives most pipeline.
...
- [Salesforce](/docs/automations/auto-outbound#using-salesforce-campaigns)
- [HubSpot](/docs/automations/auto-outbound#using-hubspot-sequences-and-workflows)
- [Apollo](/docs/automations/auto-outbound#using-outreach-sequences)
- [Clay](/docs/automations/auto-outbound#using-clay-tables)
- [Webhooks](/docs/automations/auto-outbound#extending-auto-outbound-with-webhooks)
...
### Put your Auto Outbound campaign in Autopilot
...
Check out our [Outreach Auto Outbound guide](/docs/automations/auto-outbound/outreach) for more information
...
Check out our [Salesforce Auto Outbound guide](/docs/automations/auto-outbound/salesforce) for more information.
...
Check out our [HubSpot Auto Outbound guide](/docs/automations/auto-outbound/hubspot) for more information.
...
Check out our [Apollo Auto Outbound guide](/docs/automations/auto-outbound/apollo) for more information.
...
Check out our [Clay Auto Outbound guide](/docs/automations/auto-outbound/clay) for more information.
...
Check out our [Webhooks Auto Outbound guide](/docs/automations/auto-outbound/webhooks) for more information.
