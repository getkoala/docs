...
<Accordion title="How does Koala know which companies are on my site?">
	...
	If you don't yet use Clearbit Reveal, Koala helps to autmoatically provision a
	...
	[Clearbit settings page](app.getkoala.com/projects/koala/apps/clearbit).
</Accordion>

<Accordion title="How does Koala know the geolocation of prospects?">
	Koala partners with Cloudflare to provide IP-based geolocation to give you a better 
	idea of where your visitors are from. This is especially helpful when you have an
	anonymous visitor from an account and can use the city/state/country and another tool
