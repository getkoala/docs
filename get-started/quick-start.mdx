---
title: "Quick start"
description: "A step-by-step guide to get Koala set up in under an hour."
---

*Note: we have a step-by-step welcome experience in the product that will walk you through these steps in detail. If you'd prefer that, you can simply create an account and the product will guide you through the process. 
...
This is an optional step, but strongly recommended if you're using Salesforce or Hubspot. (No worries if you're still operating out of a spreadsheet – we support you too!)
...
## Step 3: Set up an intent signal
...
## Step 4: Setting up a Slack Alert
